...
- Chaves da The Odds API nunca devem ficar hardcoded no repositório. Workflows devem injetar `ODDS_API_KEYS` e os scripts devem ler apenas `ODDS_API_KEY`, `ODDS_API_KEY_2`... via ambiente.
